...
void FarnebackPolyExpPyr(const Mat& img, vector<Mat>& poly_exp_pyr,
						 vector<float>& fscales, int poly_n, double poly_sigma)
{
    Mat fimg;
...
void calcOpticalFlowFarneback(vector<Mat>& prev_poly_exp_pyr, vector<Mat>& poly_exp_pyr,
                              vector<Mat>& flow_pyr, int winsize, int iterations)
{
    int i, k;
    Mat prevFlow, flow;
